...
const OneBookDetails = () => {
	return (
		<div className={s.oneBookDetails}>
			...
			<span className={s.bookPrice}>100$</span>
			...
			<p className={s.bookDescription}>
				Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit delectus officiis ad
				obcaecati ipsam neque qui temporibus. Soluta debitis corporis vero, voluptates saepe, fuga
			...
			<div className={s.blockWishlistAndMedia}>
				<a className={s.headerIconWishlist}>
					<svg
						...
						fill='none'
						xmlns='http://www.w3.org/2000/svg'>
						<g clip-path='url(#clip0_2046_6520)'>
							<path
			...
			<div className={s.blockSku}>
				...
				<span className={s.blockSkuValue}>Fashion, Style</span>
			</div>
		</div>
	);
};
