		...
		<div className={s.tabsContent}>
			{activeTab === 'tab1' && (
				<p className={s.tabDescription}>
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur nesciunt magni dicta
					commodi optio ullam quibusdam aliquam suscipit officia? Excepturi corporis voluptatibus
					nobis eligendi fuga? Unde blanditiis asperiores rem incidunt?
				</p>
			)}
			{activeTab === 'tab2' && (
					...
					<div className={s.allReviews}>
						...
						<div className={s.review}>
							...
							<p className={s.descriptionReview}>
								Lorem ipsum dolor, sit amet consectetur adipisicing elit. Blanditiis illum quasi
								voluptate magni recusandae doloribus, modi incidunt totam cum culpa sunt
								consequuntur, aliquid voluptatem quidem eos illo vitae. Fugiat, soluta.
							</p>
						</div>
						<div className={s.review}>
							<h3 className={s.headerReview}>
